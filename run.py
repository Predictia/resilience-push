...
download_from_api("http://178.62.156.204/", "RESILIENCE.ro", "4e975e24-2124-4572-8b74-f6264907093e", "6", ftime, global_file_location, json_dir_location)
...
write_ensemble_nc(ensemble_out_location, global_file_location, json_file_location, vtime)
